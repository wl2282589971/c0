	...
	struct formatter<miniplc0::ErrorCode> {
		...
		auto format(const miniplc0::ErrorCode &p, FormatContext &ctx) {
			...
			case miniplc0::ErrInvalidPrint:
				...
				break;
            case miniplc0::ErrLackSomething:
                name = "Something strange happened.You may lack something.";
                break;
            case miniplc0::ErrFunctionHasDefined:
                name = "This Function has Defined";
                break;
            case miniplc0::ErrNoMainFunction:
                name = "The program has no main function";
                break;
            case miniplc0::ErrConstNotAssigned:
                name = "Const should not be assigned!";
                break;
	...
	struct formatter<miniplc0::TokenType> {
		...
		auto format(const miniplc0::TokenType &p, FormatContext &ctx) {
			...
			case miniplc0::RIGHT_BRACKET:
				name = "RightBracket";
				break;
			case miniplc0::NOR_EQUAL:
			    name = "!=";
			    break;
            case miniplc0::GREAT_EQUAL:
                name = ">=";
                break;
